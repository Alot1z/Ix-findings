...
for (const f of findingsReg.findings || []) {
  const statusMap = { FIXED_UPSTREAM: "RESOLVED", PR_OPEN: "PR_OPEN", IN_PR_393: "IN_PR", INCONCLUSIVE: "UNSUPPORTED", REPRODUCED: "CURRENT", VERIFIED: "CURRENT", CONFIRMED: "CURRENT", REPRODUCED_LIVE: "CURRENT", OBSERVED: "CURRENT", OPEN: "OPEN", FIXED_FORK: "FIXED_FORK", PRE_EXISTING: "PRE_EXISTING", UPSTREAM_PR: "PR_OPEN", AUDITED: "AUDITED" };
