...
window.IX_DATA = {
  ...
  "repos": [
    ...
    },
    {
      ...
      "local_path": "E:\\E-github-repos\\Ix-findings",
      "commits": 0,
      "untracked": "165 files (17 top-level entries)",
  ...
  "contributions": [
    {
      ...
      "files": 4,
      "tests": "656/2 + 10 guard tests",
      "packet": "pr-packets/ix-remap-hardening/README.md",
      "blocker": null,
      "nextAction": "Open PR against ix-infrastructure/Ix:main (requires authorization)"
    },
    {
      "id": "CONTRIB-agent",
      "repo": "ix-infrastructure/Ix",
      ...
      "tests": null,
      "packet": null,
      "blocker": "Active development — PR #368 already merged (patched version stripped per reviewer)",
      "nextAction": "Complete overhaul, then separate PR if warranted"
    },
    {
      "id": "CONTRIB-376",
      "repo": "ix-infrastructure/Ix",
      ...
      "blocker": "Needs maintainer direction on approach (Option A vs B)",
      "nextAction": "Discuss with KageBinary after remap PR establishes credibility"
    },
    {
      "id": "CONTRIB-371",
      "repo": "ix-infrastructure/Ix",
      ...
      "tests": "Spec ready",
      "packet": null,
      "blocker": "Needs OSS vs Pro decision from maintainer",
      "nextAction": "Ask maintainer in context of remap PR"
    },
    {
      "id": "CONTRIB-fkey",
      "repo": "system-compass",
  ...
  "manifest": {
    "version": "4.0.0",
    "generated": "2026-08-10T16:00:00Z",
    "source": "CLI Execution Phase — live testing, worktree creation, workspace audit",
    ...
    "evidence": {
      "count": 28,
      "note": "S-038: previous counts of 28/164 were stale; live count is 165 files",
      "ids": [
        "E-001",
        "E-002",
        "E-003",
    ...
    "graph": {
      "nodes": 290,
      "edges": 240,
      "status": "EXPANDED - test worktree, fresh results, fork gap confirmed; see GRAPH-AUDIT.md"
    },
    "worktrees": {
      "primary": {
        "path": "E:\\E-github-repos\\Ix",
