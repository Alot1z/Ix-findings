...
| `validate-public.mjs` | Deployment gate. Runs the freshness gate by default, then checks files, JSON parse, snapshot label, excluded patterns, graph edge integrity, and relative asset refs. |
